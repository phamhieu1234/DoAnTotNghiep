<?php
    ...
    $sqli = "SELECT * FROM tbl_dangky,tbl_role where tbl_dangky.role_id = tbl_role.id_role AND `id_dangky` = '$_GET[iddangky]' LIMIT 1 ";
            ...
            <div class="panel-body">
                ...
                <form action="" method="POST" onsubmit="return validateForm();">
                    <div class="form-group">
                        <label>Họ & Tên:</label>
                        <input type="text" class="form-control" id="usr" name="hovaten" placeholder="Nhập Họ & Tên" value="<?php echo $row['tenkhachhang'] ?>">
                    </div>
                    <div class="form-group">
                        <label>Email:</label>
