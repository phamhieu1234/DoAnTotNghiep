...
if (isset($_POST['dangky'])) {
    ...
    if (empty($email) ||  empty($matkhau)  || empty($tenkhachhang) || empty($dienthoai) || empty($diachi) || strlen($matkhau) < 6) {
        ...
        //Validate thanh cong
        $userExist = "SELECT * FROM tbl_dangky where email = '$email'";
        ...
        if ($result != null) {
            ...
            $sql_dangky = mysqli_query($mysqli,"INSERT INTO tbl_dangky(tenkhachhang,email,dienthoai,matkhau,diachi,role_id) VALUE ('".$tenkhachhang."','".$email."', '".$dienthoai."', '".$matkhau."', '".$diachi."','".$id_role."' )");
            ...
            <div class="panel-body">
                ...
                <form action="" method="POST" onsubmit="return validateForm();">
                    <div class="form-group">
                        <label>Họ & Tên:</label>
                        <input type="text" class="form-control" id="usr" name="hovaten" placeholder="Nhập Họ & Tên">
                    </div>
                    <div class="form-group">
                        <label>Email:</label>
